...
#    Updated: 2024/04/30 18:41:34 by nfurlani         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS		=	main.c \
				...
				parser/env_map.c parser/parser.c parser/lst_lexer.c parser/parser_token.c parser/parser_env.c parser/lst_env.c parser/lst_export.c \
